...
public class SignupActivity extends AppCompatActivity {
    ...
    public void signup() {
        ...
        String urlJsonArry = "http://"+NavActivity.url+"/api/reg/"+email+"/"+password+"/"+name;
    ...
    public void onSignupSuccess() {
        ...
        final SharedPreferences shared = getSharedPreferences("pref2", getApplicationContext().MODE_PRIVATE);
