package com.esprit.bikeit.Util;
...
public class Password {
     ...
     * @param password_plaintext The account's plaintext password, as provided during a lougin request
    ...
    public static void main(String[] args) {
        ...
        String test_hash = "$2y$10$n45WQrHBSw18ESZktizI6egDuQfcckfSZOPIF8vgP0jqihlhTLolK";
        String ch=test_hash.replaceFirst("y","a");

        System.out.println("Testing BCrypt Password hashing and verification");
        System.out.println("Test password: " + test_passwd);
        System.out.println("Test stored hash: " + ch);
        ...
        String compare_test = checkPassword(test_passwd, ch)
